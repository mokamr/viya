...
- Modify lines 7 and 8 in [View site-config/security/sas-custom-ingress-certificate-configmap.yaml](https://github.com/mokamr/viya/blob/main/deployment/stable2025-04/site-config/security/sas-custom-ingress-certificate-configmap.yaml) with the path to the certificate and key files
  ```yaml
  files:
